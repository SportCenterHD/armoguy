# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Dutch YouTube Channels || ArmoGuy
# (c) 2015 - DOKI
...
addonID = 'plugin.video.dutchyoutubechannels'
...
# Entry point
def run():
    plugintools.log("dutchyoutubechannels.run")
...
def main_list(params):
    plugintools.log("dutchyoutubechannels.main_list "+repr(params))
